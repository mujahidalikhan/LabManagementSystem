<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointScheduleControl.ascx.cs"
    Inherits="LMIS.AppointScheduler.AppointScheduleControl" %>
...
<script type='text/javascript'>
             ...
             function loadCalendarEvents() {
                 ...
                 * FullCalendar v1.5.2 http://arshaw.com/fullcalendar/
                 ...
                 $('#calendar').fullCalendar({
                     ...
                     editable: true,
                     events: { url: "../AppointScheduler/AppointControl.aspx", borderColor: "#70951D" },
             ...
             function ajaxGetTooltipInfo(id) {
                 ...
                 $.ajax({
                     async: false,
                     type: "POST",
                     url: "../AppointScheduler/AppointControl.aspx/GetEventData",
                     data: "{'id':'" + id + "'}",
             ...
             function ajaxUpdateDroppedEvent(event, dayDelta, minuteDelta, allDay, revertFunc) {
                 if (confirm("Are you sure you want to move this event?")) {
                     ...
                     $.ajax({
                         async: false,
                         type: "POST",
                         url: "../AppointScheduler/AppointControl.aspx/UpdateEventData",
             ...
             function ajaxDeleteEvent() {
                 ...
                 $.ajax({
                     async: false,
                     type: "POST",
                     url: "../AppointScheduler/AppointControl.aspx/DeleteEvent",
                     data: "{'id':'" + $('#hdn_id').val() + "'}",
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     success: function (result) {
...
<div class="simplebox">
    ...
    <div class="body padding10">
        ...
        <br />
        <br />
        &nbsp;<asp:Button ID="Button1" runat="server" Text="Add New Appoint" CssClass="st-clear"
            OnClick="Button1_Click" Width="150px" />
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="List Appoint"
            CssClass="st-button" Width="150px" />
    </div>
</div>
