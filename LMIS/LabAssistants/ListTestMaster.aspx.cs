                    ...
                    foreach (SampleDetail sampleDeatil in SampleDetailList)
                    {
                        using (var tableBodyRow = new TableRow {TableSection = TableRowSection.TableBody})
                        {
                            ...
                            tableBodyRow.Cells.Add( new TableCell
                                            {
                                                Text = String.Format(
                                                    "<a href=\"SamplerTestMaster.aspx?atid={0}\" title=\"Edit\" class=\"icon-1 info-tooltip\"><img src='../images/icons/sidemenu/file_edit.png' width='16' height='16' alt='icon' />Edit </a> ",
