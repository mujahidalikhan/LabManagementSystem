<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jobcardPrintabe.aspx.cs" Inherits="LMIS.Manager.jobcardPrintabe"  EnableViewStateMac ="false" EnableSessionState="True" EnableEventValidation ="false" ValidateRequest ="false" ViewStateEncryptionMode ="Never" %>
...
<body>
    ...
    <asp:Panel ID="pnl1" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;
            ...
            <tr height="31">
                <td class="xl67" width="86" colspan="5" align="center">
                    <h1>
                        <b>COA Reporter</b></h1>
                </td>
            </tr>
        ...
        <div class="body padding10">
            <br />
            <table width="100%" id="TestDetailTable" runat="server">
                <thead>
                    <tr style="background-color: #acc7ce; " >
                        <th align=left>
                            Test Code
                        </th>
                         <th align=left>
