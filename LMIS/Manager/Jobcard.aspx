<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Manager.Master" AutoEventWireup="true"
    CodeBehind="Jobcard.aspx.cs" Inherits="LMIS.Manager.Jobcard" EnableViewStateMac="false"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="simplebox grid740" style="width: 99%;">
        ...
        <table>
            <tr>
                <td style="width: 200px">
                    ...
                    &nbsp;
                    <asp:Button ID="Button3" runat="server" CausesValidation="False" Text="Send E-Card COA Reporter"
        ...
        <br />
        <p>
            <asp:Button ID="Button1" runat="server" Text="Verified" OnClick="Button1_Click" Width="166px"
                BackColor="#A9B0BE" BorderColor="#A9B0BE" BorderStyle="Solid" CssClass="st-button" />
            &nbsp;
