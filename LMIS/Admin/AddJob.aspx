<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddJob.aspx.cs" Inherits="LMIS.Admin.AddEditJob" EnableViewStateMac="false"
                                ...
                                <div style="z-index: 690;" class="body">
                                    ...
                                    <div style="z-index: 680;" class="st-form-line">
                                        ...
                                        <asp:DropDownList ID="ClientName" runat="server" class="styled-selectSmall" Width="288px"
                                            OnSelectedIndexChanged="ClientName_SelectedIndexChanged" AutoPostBack="True"
                                            Height="30px">
                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div id="QuotatonTestDetail" runat="server">
                                        ...
                                        <div style="z-index: 690; width: 90%" class="st-tinytitle">
                                            ...
                                            <span class="st-labeltext">STANDARD</span><table>
                                                <tr>
                                                    <td>
                                                        <asp:RadioButton ID="RadioButton1" runat="server" GroupName="STANDARD" Text="STD A"
                                                            Checked="True" />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                    <td>
                                                        <asp:RadioButton ID="RadioButton2" runat="server" GroupName="STANDARD" Text="STD B" />
                                                    </td>
                                                    <td>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:RadioButton ID="RadioButton3" runat="server" GroupName="STANDARD" Text="OTHERS" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div style="z-index: 690; width: 100%" class="st-tinytitle">
                                            <h3>
                                                TEST PARAMETER DETAILS</h3>
                                            <span class="st-labeltext">TEST TYPES</span>
                                            <div style="z-index: 670;" class="clear">
                                            </div>
                                            &nbsp; &nbsp; &nbsp;
                                            <asp:CheckBox ID="AllTest" runat="server" AutoPostBack="True" Checked="False" OnCheckedChanged="AllTest_CheckedChanged"
                                                Text="SELECT ALL" />
                                            &nbsp; &nbsp;<asp:CheckBox ID="uncheckAll" runat="server" AutoPostBack="True" Checked="False"
                                                OnCheckedChanged="AllTest0_CheckedChanged" Text="UNSELECT ALL" />
                                            <div style="z-index: 670;" class="clear">
                                                <br />
                                                <br />
                                            </div>
                                            ...
                                            <asp:Panel ID="pnl1" runat="server" Width="100%">
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <div class="simplebox grid740" style="z-index: 720; margin-left: 20px; width: 323px;
                                                            height: 150px; margin-top: -30px">
                                                            <div class="body" style="z-index: 690; height: 150px; overflow: auto; overflow-x: hidden;
                                                                -ms-overflow-x: hidden;">
                                                                <asp:CheckBoxList ID="check1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="check1_SelectedIndexChanged"
                                                                    TextAlign="Right">
                                                                </asp:CheckBoxList>
                                                            </div>
                                                        </div>
                                            ...
                                            <div style="z-index: 690; width: 90%" class="st-tinytitle">
                                                ...
                                                <asp:DropDownList ID="SamplePacking" runat="server" Width="250px" />
                                                <div style="z-index: 670;" class="clear">
                                                <br/>
                                                </div>
                                                <span class="st-labeltext">Sample Received on </span>
                                                <script type="text/javascript">
                                                    $(function () {
                                                        $("#<%= SampleReciveOnDate.ClientID %>").datepicker({ dateFormat: 'dd/mm/yy' }).val();
                                                    });
                                                </script>
                                                <asp:TextBox ID="SampleReciveOnDate" runat="server" class="datepicker-input" Width="240px"></asp:TextBox>
                                            </div>
                                            <span class="st-labeltext">Type of Sampling :</span>
                                            <asp:TextBox ID="TypeOfSample" runat="server" Width="240"></asp:TextBox>
                                            <div style="z-index: 670;" class="clear">
                                            <br/>
                                            </div>
                                            ...
                                            <br />
                                            <div style="z-index: 460;" class="button-box">
                                                <asp:Button ID="btnAddTestInformation" runat="server" Width="200px" Text="Add Test Information"
                                                    CssClass="st-clear" OnClick="btnAddTestInformation_Click" />
                                            </div>


                                            <br />
                                            <div class="grid740" style="width: 100%; margin-right: 1%; margin-left: 1%;">
                                                <div class="simplebox">
                                                    <div class="titleh">
                                                        <h3>
                                                    ...
                                                    <div class="body padding10">
                                                        <table id="TestInformation" runat="server" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <div style="z-index: 690; width: 90%" class="st-tinytitle">
                                            ...
                                            <b><span class="st-labeltext">Select Test: </span>
