<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddEditTestParameterInfo.aspx.cs" Inherits="LMIS.Admin.AddEditTestParameterInfo" EnableViewStateMac ="false" EnableSessionState="True" EnableEventValidation ="false" ValidateRequest ="false" ViewStateEncryptionMode ="Never"  %>
    ...
    <div class="simplebox">
        ...
        <div class="body padding10">
            <div style="z-index: 680;" class="st-form-line">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccreditedTestParameter"
                    CssClass="st-form-error" ErrorMessage="*Please enter accredited parameter"></asp:RequiredFieldValidator>
            </div>
            <div style="z-index: 680;" class="st-form-line">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TestMethod"
                    CssClass="st-form-error" ErrorMessage="*Please enter test method"></asp:RequiredFieldValidator>
            </div>
            <div style="z-index: 680;" class="st-form-line">
                <span class="st-labeltext">Unit:</span>
                <asp:TextBox ID="Unit" runat="server" class="st-forminput" Width="188px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Unit"
                    CssClass="st-form-error" ErrorMessage="*Please enter unit"></asp:RequiredFieldValidator>
            </div>
            <div style="z-index: 680;" class="st-form-line">
