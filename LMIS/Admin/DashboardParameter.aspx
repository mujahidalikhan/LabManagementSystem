<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DashboardParameter.aspx.cs" 
Inherits="LMIS.Admin.DashboardParameter"    EnableViewStateMac="false" EnableSessionState="True" EnableEventValidation="false"
    ...
    <div style="z-index: 690;" class="body">
        <div style="z-index: 680;" class="st-form-line">
           ...
           <%-- <script type="text/javascript" charset="utf-8">
            ...
            <asp:Table ID="SpecificationTable" runat="server" class="tablesorter" Width="100%"
